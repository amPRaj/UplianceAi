    ...
    return (
        <div className="bg-gray-600 rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-out">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            />
            <button className="rounded-2xl m-2 text-blue-900 text-sm bg-white w-2/5 px-4 py-2 shadow-md hover:text-white hover:bg-green-600 transition duration-200 ease-in " onClick={signInfun}>
              Sign In
            </button>
          </div>
